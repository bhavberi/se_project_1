...
public class UserBookDao {
    ...
    public UserBook getUserBook(String userBookId, String userId) {
        ...
        Query q = em.createQuery(
                "select ub from UserBook ub where ub.id = :userBookId and ub.userId = :userId and ub.deleteDate is null");
    ...
    public UserBook getByBook(String bookId, String userId) {
        EntityManager em = ThreadLocalContext.get().getEntityManager();
        Query q = em.createQuery(
                "select ub from UserBook ub where ub.bookId = :bookId and ub.userId = :userId and ub.deleteDate is null");
     ...
     * @throws Exception
     */
    public void findByCriteria(PaginatedList<UserBookDto> paginatedList, UserBookCriteria criteria,
            SortCriteria sortCriteria) throws Exception {
        Map<String, Object> parameterMap = new HashMap<String, Object>();
        List<String> criteriaList = new ArrayList<String>();

        StringBuilder sb = new StringBuilder(
                "select ub.UBK_ID_C c0, b.BOK_TITLE_C c1, b.BOK_SUBTITLE_C c2, b.BOK_AUTHOR_C c3, b.BOK_LANGUAGE_C c4, b.BOK_PUBLISHDATE_D c5, ub.UBK_CREATEDATE_D c6, ub.UBK_READDATE_D c7");
        sb.append(" from T_BOOK b ");
        sb.append(
                " join T_USER_BOOK ub on ub.UBK_IDBOOK_C = b.BOK_ID_C and ub.UBK_IDUSER_C = :userId and ub.UBK_DELETEDATE_D is null ");
        ...
        if (criteria.getTagIdList() != null && !criteria.getTagIdList().isEmpty()) {
            ...
            for (String tagId : criteria.getTagIdList()) {
                sb.append(" left join T_USER_BOOK_TAG ubk" + index + " on ubk" + index
                        + ".BOT_IDUSERBOOK_C = ub.UBK_ID_C and ubk" + index + ".BOT_IDTAG_C = :tagId" + index + " ");
