...
/**
 * This filter is used to authenticate the user having an active session via an
 * authentication token stored in database.
 ...
 * If not, the user is anonymous, and the filter injects a AnonymousPrincipal
